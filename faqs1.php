...
<div id="content-wrapper">
	<div style="margin: 20px;">
		<h1 style="color:black";>Frequently Asked Questions (FAQs)

		<h3 style="color:black";>Why do I need to register on the site before I can place an order?</h3>
		...
		<h3 style="color:black";>How long does it take for delivery to PH destinations?</h3>

		<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;For domestic shipments, please allow 2 - 3 weeks for delivery.</p>

		<h3 style="color:black";>How long does it take for delivery to International destinations?</h3>
		...
		<h3 style="color:black";>Are transactions safe?</h3>
		...
		<h3 style="color:black";>How will BookSure protect my anonymity?</h3>
